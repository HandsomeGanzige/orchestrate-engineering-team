...
const REQUIRED = Object.freeze(["SKILL.md", "agents/openai.yaml", "assets/main-work-brief.md", "assets/role-task-packet.md", "references/role-contracts.yaml", "references/config.schema.json"]);
...
export async function checkAgentProfiles(root) {
  ...
  if (diagnostics.length) return { ok: false, diagnostics, summary: { skills: 1, roles: 4, mainResources: 4 } };
  ...
  return { ok: diagnostics.length === 0, diagnostics, summary: { skills: 1, roles: 4, mainResources: 4 } };
}
