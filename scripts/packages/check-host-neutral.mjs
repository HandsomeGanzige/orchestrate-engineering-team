...
const files = ["packages/config/src/index.js", "packages/adapter-contract/src/index.js", ".agents/skills/orchestrate-engineering-team/references/role-contracts.yaml"];
