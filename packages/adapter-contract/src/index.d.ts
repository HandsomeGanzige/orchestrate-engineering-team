...
export type LaunchPlan = { adapter: string; agent: string; mode: "native" | "prompt-fallback"; toolsPolicy: "allowlist" | "denylist" | "inherited" | "advisory" | "unknown"; sandbox: "read-only" | "workspace-write" | "inherited" | "unknown"; isolation: "worktree" | "sandbox" | "shared" | "unknown"; resultDelivery?: "terminal-result" | "receipt-notification" | "text-only" | "unknown"; dependencyBarrier?: "terminal-only" | "nonterminal-possible" | "unknown"; supervisorContinuation?: "automatic" | "parent-managed" | "unsupported" | "unknown"; limitations: string[]; grantedCapabilities?: string[]; prompt?: string };
